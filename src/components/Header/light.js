	...
	return (
		<Header className={className || 'header-light'}>
			...
			>
				...
				>
					{showNavLinks ? (
						<CloseIcon tw='w-6 h-6' style={{ color: 'white' }} />
					) : (
						<MenuIcon tw='w-6 h-6' style={{ color: 'white' }} />
					)}
				</NavToggle>
			</MobileNavLinksContainer>
		</Header>
 ...
 * Its written like thi s because we are using macros and we can not insert dynamic variables in macros
 */
