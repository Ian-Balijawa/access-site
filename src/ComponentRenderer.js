...
import BackgroundAsImageHero from 'components/heros/BackgroundAsImage.js';
import IllustrationAndVideoHero from 'components/heros/TwoColumnWithVideo.js';
import IllustrationAndInputHero from 'components/heros/TwoColumnWithInput.js';
import FeaturesAndTestimonialHero from 'components/heros/TwoColumnWithFeaturesAndTestimonial.js';
import FullWidthWithImageHero from 'components/heros/FullWidthWithImage.js';
import BackgroundAsImageWithCenteredContentHero from 'components/heros/BackgroundAsImageWithCenteredContent.js';
import IllustrationAndPrimaryBackgroundHero from 'components/heros/TwoColumnWithPrimaryBackground.js';
		...
		Features: {
			...
			elements: {
				...
				ThreeColCenteredStatsPrimaryBackground: {
					...
					component:
						ThreeColCenteredStatsWithPrimaryBackgroundFeatures,
		...
		Testimonial: {
			...
			elements: {
				...
				TwoColumnWithImageAndProfilePictureReview: {
					...
					component:
						TwoColumnWithImageAndProfilePictureReviewTestimonial,
